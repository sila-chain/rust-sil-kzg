...
use rust_sil_kzg::constants::RECOMMENDED_PRECOMP_WIDTH;
...
/*
 * Note: All methods in this file have been prefixed with `sil_kzg`.
...
pub struct DASContext {
    inner: rust_sil_kzg::DASContext,
}

impl DASContext {
    pub fn inner(&self) -> &rust_sil_kzg::DASContext {
        &self.inner
    }
}

impl Deref for DASContext {
    type Target = rust_sil_kzg::DASContext;
...
/// by calling `sil_kzg_das_context_free`.
#[no_mangle]
pub extern "C" fn sil_kzg_das_context_new(use_precomp: bool) -> *mut DASContext {
    let use_precomp = if use_precomp {
        rust_sil_kzg::UsePrecomp::Yes {
            width: RECOMMENDED_PRECOMP_WIDTH,
        }
    } else {
        rust_sil_kzg::UsePrecomp::No
    };

    let ctx = Box::new(DASContext {
        inner: rust_sil_kzg::DASContext::new(&rust_sil_kzg::TrustedSetup::default(), use_precomp),
    });
    Box::into_raw(ctx)
}
...
///   a pointer that was not created by `sil_kzg_das_context_new`.
#[allow(clippy::not_unsafe_ptr_arg_deref)]
#[no_mangle]
pub extern "C" fn sil_kzg_das_context_free(ctx: *mut DASContext) {
    if ctx.is_null() {
        return;
    }
    unsafe {
...
impl CResult {
    ...
    ///   This can be done by calling `sil_kzg_free_error_message`.
    ///
    /// # Memory faults
    ///
    /// - If this method is called twice on the same pointer, it will result in a double-free.
...
/// - The caller should also avoid a double-free by setting the pointer to null after calling this method.
#[no_mangle]
pub unsafe extern "C" fn sil_kzg_free_error_message(c_message: *mut std::os::raw::c_char) {
...
#[no_mangle]
#[must_use]
pub extern "C" fn sil_kzg_blob_to_kzg_commitment(
...
#[no_mangle]
#[must_use]
pub extern "C" fn sil_kzg_compute_cells_and_kzg_proofs(
    ctx: *const DASContext,
...
#[no_mangle]
#[must_use]
pub extern "C" fn sil_kzg_compute_cells(
    ctx: *const DASContext,
...
#[no_mangle]
#[must_use]
pub extern "C" fn sil_kzg_verify_cell_kzg_proof_batch(
    ctx: *const DASContext,
...
#[no_mangle]
#[must_use]
pub extern "C" fn sil_kzg_recover_cells_and_proofs(
    ctx: *const DASContext,
...
#[no_mangle]
pub extern "C" fn sil_kzg_constant_bytes_per_cell() -> u64 {
    BYTES_PER_CELL as u64
}
#[no_mangle]
pub extern "C" fn sil_kzg_constant_bytes_per_proof() -> u64 {
    BYTES_PER_COMMITMENT as u64
}
#[no_mangle]
pub extern "C" fn sil_kzg_constant_cells_per_ext_blob() -> u64 {
...
#[no_mangle]
#[must_use]
pub extern "C" fn sil_kzg_compute_kzg_proof(
    ctx: *const DASContext,
    blob: *const u8,
    z: *const u8,
    out_proof: *mut u8,
...
#[no_mangle]
#[must_use]
pub extern "C" fn sil_kzg_compute_blob_kzg_proof(
    ctx: *const DASContext,
    blob: *const u8,
    commitment: *const u8,
    out_proof: *mut u8,
...
#[no_mangle]
#[must_use]
pub extern "C" fn sil_kzg_verify_kzg_proof(
    ctx: *const DASContext,
    commitment: *const u8,
    z: *const u8,
    y: *const u8,
...
#[no_mangle]
#[must_use]
pub extern "C" fn sil_kzg_verify_blob_kzg_proof(
    ctx: *const DASContext,
    blob: *const u8,
    commitment: *const u8,
    proof: *const u8,
...
#[no_mangle]
#[must_use]
pub extern "C" fn sil_kzg_verify_blob_kzg_proof_batch(
    ctx: *const DASContext,
    blobs_length: u64,
