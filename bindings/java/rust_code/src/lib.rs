...
#[no_mangle]
pub extern "system" fn Java_sila_cryptography_LibSilKZG_DASContextNew(
    _env: JNIEnv,
    _class: JClass,
    use_precomp: jboolean,
) -> jlong {
    let use_precomp = use_precomp != 0;
    c_sil_kzg::sil_kzg_das_context_new(use_precomp) as jlong
}

#[no_mangle]
pub extern "system" fn Java_sila_cryptography_LibSilKZG_DASContextDestroy(
    _env: JNIEnv,
    _class: JClass,
    ctx_ptr: jlong,
) {
    c_sil_kzg::sil_kzg_das_context_free(ctx_ptr as *mut DASContext);
}

#[no_mangle]
pub extern "system" fn Java_sila_cryptography_LibSilKZG_computeCellsAndKZGProofs<'local>(
...
#[no_mangle]
pub extern "system" fn Java_sila_cryptography_LibSilKZG_computeCells<'local>(
    mut env: JNIEnv<'local>,
    _class: JClass,
    ctx_ptr: jlong,
    blob: JByteArray<'local>,
...
#[no_mangle]
pub extern "system" fn Java_sila_cryptography_LibSilKZG_blobToKZGCommitment<'local>(
    mut env: JNIEnv<'local>,
    _class: JClass,
    ctx_ptr: jlong,
    blob: JByteArray<'local>,
...
#[no_mangle]
pub extern "system" fn Java_sila_cryptography_LibSilKZG_verifyCellKZGProofBatch<'local>(
    mut env: JNIEnv<'local>,
    _class: JClass,
    ctx_ptr: jlong,
...
#[no_mangle]
pub extern "system" fn Java_sila_cryptography_LibSilKZG_recoverCellsAndKZGProofs<'local>(
    mut env: JNIEnv<'local>,
    _class: JClass,
    ctx_ptr: jlong,
    cell_ids: JLongArray,
...
#[no_mangle]
pub extern "system" fn Java_sila_cryptography_LibSilKZG_computeKzgProof<'local>(
    mut env: JNIEnv<'local>,
    _class: JClass,
    ctx_ptr: jlong,
    blob: JByteArray<'local>,
...
#[no_mangle]
pub extern "system" fn Java_sila_cryptography_LibSilKZG_computeBlobKzgProof<'local>(
    mut env: JNIEnv<'local>,
    _class: JClass,
    ctx_ptr: jlong,
    blob: JByteArray<'local>,
...
#[no_mangle]
pub extern "system" fn Java_sila_cryptography_LibSilKZG_verifyKzgProof<'local>(
    mut env: JNIEnv<'local>,
    _class: JClass,
    ctx_ptr: jlong,
    commitment: JByteArray<'local>,
...
#[no_mangle]
pub extern "system" fn Java_sila_cryptography_LibSilKZG_verifyBlobKzgProof<'local>(
    mut env: JNIEnv<'local>,
    _class: JClass,
    ctx_ptr: jlong,
    blob: JByteArray<'local>,
...
#[no_mangle]
pub extern "system" fn Java_sila_cryptography_LibSilKZG_verifyBlobKzgProofBatch<'local>(
    mut env: JNIEnv<'local>,
    _class: JClass,
    ctx_ptr: jlong,
