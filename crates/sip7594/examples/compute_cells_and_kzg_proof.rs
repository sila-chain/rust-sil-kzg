...
//!
//! The functionality shown here is part of the [SIP-7594 (PeerDAS)](https://eips.ethereum.org/EIPS/eip-7594)
...
use rust_sil_kzg::{constants::BYTES_PER_BLOB, DASContext, TrustedSetup};
